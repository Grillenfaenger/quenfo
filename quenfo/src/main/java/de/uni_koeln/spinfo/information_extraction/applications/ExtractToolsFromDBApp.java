...
public class ExtractToolsFromDBApp {
	...
	static int startPos = 6000;
	static int maxCount = 100;
	static boolean matchWithDataBase = true;

	// Path to input database
	static String dbInputPath = /* "D:/Daten/sqlite/ClassifiedParagraphs.db"; */"C:/sqlite/ClassifiedParagraphs.db";
	// Path to output database
	static String stdOutputPath = "C:/sqlite/";/*D:/Daten/sqlite*/
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException, IOException {
		...
		toolExtractor.extractTools(startPos, maxCount, matchWithDataBase, tableSize, inputConnection, outputConnection,
				toolsFile, noToolsFile, contextFile);
	}
