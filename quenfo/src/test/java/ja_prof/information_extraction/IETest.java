...
public class IETest {
	...
	public static void prepare() throws IOException {
		classifyUnitsFile = new File(
				...
				//	"classification/data/trainingDataScrambled.csv");
					"classification/data/newTrainingData_class3.csv");
		//Translations
		...
		sentencesFile = new File("src/test/resources/information_extraction/output/sentences_"+sb.toString()+".txt");
		sentenceDataFileName = "src/test/resources/information_extraction/output/sentenceData_"+sb.toString();
		competenceDataOutputFile = new File("src/test/resources/information_extraction/competenceData_"+sb.toString()+".txt");
	}
	
	@Test
	public void filterClassifyUnitsTest() throws IOException {
		List<ClassifyUnit> cus = jobs.getCategorizedParagraphsFromFile(
				classifyUnitsFile);
	...
	public void initializeCompetenceUnitsTest() throws IOException{
		...
		System.out.println(compUnits.size());
	...
	public void setSentenceDataTest() throws IOException {
		...
		for (CompetenceUnit compUnit : compUnits) {
			...
			Assert.assertEquals(compUnit.getLemmata().length,
					compUnit.getMorphTags().length);
			Assert.assertEquals(compUnit.getLemmata().length,
					compUnit.getPosTags().length);
		}
	}
